...
//   // Preload AR model when card is near viewport
//   useEffect(() => {
...
//       },
//       { 
//         rootMargin: '300px', // Start preloading 300px before visible
//         threshold: 0
//       }
//     );
...
export default function MenuItemCard({
  ...
  // Preload only when user hovers near AR button
  ...
  return (
    <div className="flex flex-col gap-2" onMouseEnter={hasAR ? handleMouseEnter : undefined}>
      {/* IMAGE */}
      <div className="relative rounded-2xl overflow-hidden">
        <img
          src={item.imageUrl || item.thumbnailUrl}
      ...
      {/* HIDDEN AR PRELOADER - Only on hover */}
      {preloadStarted && hasAR && glbUrl && (
        <model-viewer
          src={glbUrl}
          loading="eager"
          reveal="interaction"
