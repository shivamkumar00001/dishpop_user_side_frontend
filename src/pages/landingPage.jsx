...
//             <button
//               onClick={goToMenu}
//               className="bg-white text-green-700 px-6 py-3 rounded-xl font-bold hover:bg-gray-50 transition-colors shadow-lg"
//             >
//               Explore Menu
//             </button>
...
//             <button
//               onClick={goToReviews}
//               className="bg-white/10 backdrop-blur-sm text-white border-2 border-white px-6 py-3 rounded-xl font-bold hover:bg-white/20 transition-colors flex items-center justify-center gap-2"
//             >
